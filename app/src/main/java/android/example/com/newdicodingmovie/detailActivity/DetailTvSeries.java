...
public class DetailTvSeries extends BaseAppCompatActivity {
TextView mTitle,mRating,mReleaseDate,mOverview;
ImageView mPoster,mBackdrop;
FloatingActionButton mFavorite;
    public static final String MOVIE_ITEM = "tv_series";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeriesParcelable fill = getIntent().getParcelableExtra(MOVIE_ITEM);
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(fill.getTitle());
        getDataSqlite();
    ...
    private void getDataSqlite(){
        SeriesParcelable fill = getIntent().getParcelableExtra("tv_series");
