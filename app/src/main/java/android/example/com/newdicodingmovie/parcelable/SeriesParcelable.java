...
public class SeriesParcelable implements Parcelable {
    @SerializedName("id")
    private int id;
    @SerializedName("name")
    ...
    public SeriesParcelable(JSONObject object) {
        try {
    ...
    protected SeriesParcelable(Parcel in) {
        id = in.readInt();
        title = in.readString();
    ...
    public static final Creator<SeriesParcelable> CREATOR = new Creator<SeriesParcelable>() {
        @Override
        public SeriesParcelable createFromParcel(Parcel in) {
            return new SeriesParcelable(in);
        }

        @Override
        public SeriesParcelable[] newArray(int size) {
            return new SeriesParcelable[size];
        }
    };
    ...
    public SeriesParcelable(Cursor cursor) {
